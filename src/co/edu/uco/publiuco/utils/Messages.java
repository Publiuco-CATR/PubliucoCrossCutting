...
public class Messages {
	...
	public static final class ComentarioLectorSql{
		...
		public static final String TECHNICAL_MESSAGE_READ_JAVA_EXCEPTION = "Se ha presentado un  problema inesperado dentro del metodo READ de la clase ComentarioLectorSqlDAO de tipo Exception. Por favor verifique la traza completa de la excepcion presentada";
